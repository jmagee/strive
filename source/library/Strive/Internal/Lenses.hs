...
module Strive.Internal.Lenses
  ...
  , ReadScopeLens(readScope)
  , ReadAllScopeLens(readAllScope)
  , ProfileReadAllScopeLens(profileReadAllScope)
  , ProfileWriteScopeLens(profileWriteScope)
  , ActivityReadScopeLens(activityReadScope)
  , ActivityReadAllScopeLens(activityReadAllScope)
  , ActivityWriteScopeLens(activityWriteScope)
  , ProfileLens(profile)
  ...
  , StateLens(state)
  , StatusLens(status)
  , ApplicationIdLens(applicationId)
  , CallbackUrlLens(callbackUrl)
  , TitleLens(title)
  , AuthorizedLens(authorized)
  , ObjectTypeLens(objectType)
  , ObjectIdLens(objectId)
  , AspectTypeLens(aspectType)
  , UpdatesLens(updates)
  , OwnerIdLens(ownerId)
  , SubscriptionIdLens(subscriptionId)
  , EventTimeLens(eventTime)
...
$(makeLenses "SubscriptionDetail")
$(makeLenses "SubscriptionEvent")
$(makeLenses "SubscriptionUpdate")
